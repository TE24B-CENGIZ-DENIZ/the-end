...
// charachter designer devide into dmg and name designer
static void characterDesigner( int regularAttackDmg, string regularAttackName, int superAttackDmg, string superAttackName)
{

  

  //charachter name is == player answer after the loop is done for that is done so that it becomes one of the correct answers
...
// static (int,int,int) hi(string hi)
// {
//   int hel= 4;
//   int of= 5;
//   int yey= 6;
...
//need type converting (stamina option), random chance,pseudo code,if and else, return valiue, 
